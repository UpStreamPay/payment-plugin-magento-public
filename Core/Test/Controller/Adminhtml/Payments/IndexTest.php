...
namespace UpStreamPay\Core\Test\Controller\Adminhtml\Payments;
...
use UpStreamPay\Core\Controller\Adminhtml\Payments\Index;
use PHPUnit\Framework\TestCase;

/**
 * Class IndexTest
 *
 * @package UpStreamPay\Core\Test\Controller\Adminhtml\Payments
 */
class IndexTest extends TestCase
{
    ...
    public function testExecute(): void
    {
        ...
        $pageMock->expects(self::once())
            ...
            ->with('UpStreamPay_Core::payments');

        $pageTitleMock->expects(self::once())
            ->method('prepend')
            ->with(__('Payments grid'))
        ;
